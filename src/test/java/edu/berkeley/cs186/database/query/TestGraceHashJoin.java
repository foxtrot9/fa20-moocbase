...
public class TestGraceHashJoin {
    ...
    public void testSimpleGHJ() {
        try(Transaction transaction = d.beginTransaction()) {
            ...
            GraceHashJoin ghj = new GraceHashJoin(leftIter, rightIter, 1, 1, transaction.getTransactionContext(), schema, schema, true);
    ...
    public void testGHJDifferentSchemas() {
        try(Transaction transaction = d.beginTransaction()) {
            ...
            GraceHashJoin ghj = new GraceHashJoin(leftIter, rightIter, 0, 1, transaction.getTransactionContext(), schema1, schema2, true);
    ...
    public void testBreakSHJButPassGHJ() {
        try(Transaction transaction = d.beginTransaction()) {
            ...
            GraceHashJoin ghj = new GraceHashJoin(leftIter, rightIter, 0, 0, transaction.getTransactionContext(), schema, schema, false);
